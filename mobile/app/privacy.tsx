...
export function PrivacyCopy() {
  return (
    <View style={styles.copyGroup}>
      ...
      <Text style={styles.copy}>Remote schema and consent versions, a random installation token and a pseudonymous RevenueCat app-user ID are sent to ConvoAutopsy&apos;s Cloudflare service for request validation, abuse prevention, plan verification, and allowance enforcement. Response drafting also sends analysis schema and mode to the service. The exact-data review does not display the raw technical identifiers. Neither raw technical identifier is forwarded to Groq. RevenueCat processes the pseudonymous app-user ID and purchase and entitlement history, but does not receive conversation text. The ConvoAutopsy service may cache verified entitlement status for up to five minutes.</Text>
