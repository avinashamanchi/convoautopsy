...
- **External configuration pending:** Apple, RevenueCat, Cloudflare, Groq, EAS, and account configuration are not inferred from repository files. Privacy, Terms, and Support were independently verified again on 2026-08-14 and must be rechecked immediately before submission.
